...
#if defined(MACOS_X) && defined(__LP64__) && !defined(Q3_VM)
#define VMMAIN_RETURN_TYPE	intptr_t
#else
#define VMMAIN_RETURN_TYPE	int
#endif
...
#else
/* i386 and arm64 Mac are little-endian (zip/network data is LE) */
